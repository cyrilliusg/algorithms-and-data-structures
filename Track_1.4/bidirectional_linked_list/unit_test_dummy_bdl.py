...
from bidirectional_linked_list_with_dummy_node import Dummy
...
class UnitTestSortMethods(unittest.TestCase):
    ...
    def test_delete_one_value_many_vals(self):
        ...
        self.assertEqual(l_list.head.next.value, 2)
        self.assertEqual(l_list.tail.prev.value, 2)
    ...
    def test_delete_all_value_many_vals(self):
        ...
        test_arr = []
        self.assertEqual(l_list.len(), len(test_arr))
        self.assertEqual(l_list.head.next, l_list.tail)
        self.assertEqual(l_list.tail.prev, l_list.head)
    ...
    def test_delete_all_occurrences_many_values(self):
        ...
        self.assertEqual(l_list.head.value, None)
        self.assertEqual(l_list.tail.value, None)
    ...
    def test_insert_in_empty_list(self):
        ...
        self.assertEqual(l_list.head.next.value, 1)
        self.assertEqual(l_list.tail.prev.value, 1)
    ...
    def test_insert_in_many_val_list(self):
        ...
        value = 2
        l_list.insert(l_list.head.next, Node(value))  # в середину
        ...
        self.assertEqual(l_list.head.next.value, 1)
        self.assertEqual(l_list.tail.prev.value, 3)
