...
class CursorLinkedList:
    ...
    def __init__(self) -> None:
        ...
        self._head_status = CursorLinkedList.HEAD_NIL
        self._tail_status = CursorLinkedList.TAIL_NIL
        self._right_status = CursorLinkedList.RIGHT_NIL
        self._put_right_status = CursorLinkedList.PUT_RIGHT_NIL
        self._put_left_status = CursorLinkedList.PUT_LEFT_NIL
        self._remove_status = CursorLinkedList.REMOVE_NIL
        self._replace_status = CursorLinkedList.REPLACE_NIL
        self._find_status = CursorLinkedList.FIND_NIL
        self._add_to_empty_status = CursorLinkedList.ADD_TO_EMPTY_NIL
        self._add_tail_status = CursorLinkedList.ADD_TAIL_NIL
        self._get_status = CursorLinkedList.GET_NIL
    ...
    def head_op(self) -> None:
        ...
        if self.head is None:
            self._head_status = CursorLinkedList.HEAD_ERR
        else:
            self.cursor = self.head
            self._head_status = CursorLinkedList.HEAD_OK
    ...
    def tail_op(self) -> None:
        ...
        Если бы tail реализовывалась через последовательное перемещение курсора с помощью right() или иного обхода,
        то в худшем случае потребовалось бы пройти через все элементы (сложность O(n)).
        """
        if self.tail is None:
            self._tail_status = CursorLinkedList.TAIL_ERR
        else:
            self.cursor = self.tail
            self._tail_status = CursorLinkedList.TAIL_OK
    ...
    def right(self) -> None:
        ...
        if self.cursor is None or self.cursor.next is None:
            self._right_status = CursorLinkedList.RIGHT_ERR
        else:
            self.cursor = self.cursor.next
            self._right_status = CursorLinkedList.RIGHT_OK
    ...
    def put_right(self, value: Any) -> None:
        ...
        if self.cursor is None:
            self._put_right_status = CursorLinkedList.PUT_RIGHT_ERR
            return
        ...
        self._put_right_status = CursorLinkedList.PUT_RIGHT_OK
    ...
    def put_left(self, value: Any) -> None:
        ...
        """
        if self.cursor is None:
            self._put_left_status = CursorLinkedList.PUT_LEFT_ERR
            return
        ...
        self._put_left_status = CursorLinkedList.PUT_LEFT_OK
    ...
    def remove(self) -> None:
        ...
        """
        if self.cursor is None:
            self._remove_status = CursorLinkedList.REMOVE_ERR
            return
        ...
        self._remove_status = CursorLinkedList.REMOVE_OK
    ...
    def add_to_empty(self, value: Any) -> None:
        ...
        if self.head is not None or self.tail is not None or self.cursor is not None:
            self._add_to_empty_status = CursorLinkedList.ADD_TO_EMPTY_ERR
            return
        ...
        self._add_to_empty_status = CursorLinkedList.ADD_TO_EMPTY_OK
    ...
    def add_tail(self, value: Any) -> None:
        ...
        if self.head is None:
            ...
            if self._add_to_empty_status == CursorLinkedList.ADD_TO_EMPTY_OK:
                self._add_tail_status = CursorLinkedList.ADD_TAIL_OK
            else:
                self._add_tail_status = CursorLinkedList.ADD_TAIL_ERR
            return
    ...
    def replace(self, value: Any) -> None:
        ...
        """
        if self.cursor is None:
            self._replace_status = CursorLinkedList.REPLACE_ERR
            return

        self.cursor.value = value
        self._replace_status = CursorLinkedList.REPLACE_OK
    ...
    def find(self, value: Any) -> None:
        ...
        """
        if self.cursor is None:
            self._find_status = CursorLinkedList.FIND_ERR
            return
        ...
        if found:
            self._find_status = CursorLinkedList.FIND_OK
        else:
            self._find_status = CursorLinkedList.FIND_ERR
    ...
    def get(self) -> Optional[Any]:
        ...
        """
        if self.cursor is None:
            self._get_status = CursorLinkedList.GET_ERR
            return None

        self._get_status = CursorLinkedList.GET_OK
